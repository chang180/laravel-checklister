                    ...
                    <table class="table">
                        @foreach ($list_tasks as $task)
                            <tr>
                                ...
                                <td width="90%">
                                    <a href="#"
                                        wire:click.prevent="toggle_task({{ $task->id }})">{{ $task->name }}</a>
                ...
                <div class="card-body">
                    <div class="float-right">
                        @if ($current_task->is_important)
                            <a href="#" wire:click.prevent="mark_as_important({{ $current_task->id }})">&starf;</a>
                        @else
                            <a href="#" wire:click.prevent="mark_as_important({{ $current_task->id }})">&star;</a>
                        @endif
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if ($current_task->due_date)
                        ...
                        &nbsp;&nbsp;
                        <a wire:click.prevent="set_due_date({{ $current_task->id }} )" href="#">{{ __('Remove') }}
                        </a>
                    @else
                        ...
                        @if ($due_date_opened)
                            <ul>
                                ...
                                <li>
                                    <a wire:click.prevent="set_due_date({{ $current_task->id }},'{{ today()->addWeek()->toDateString() }} ' )"
                                        href="#">
                                        {{ __('Next Week') }}
                                    </a>
                                </li>
